...
uses
  ...
  Dialogs, uFrmPadrao, uFrameConfirmaCancela, ExtCtrls, Grids, DBGrids, Mask, 
  StdCtrls, Buttons, Menus, FMTBcd, DB, DBClient, Provider, DBCtrls, ActnList, 
...
uses
  uDmConexao, uLibrary, uDmWorkCom, uFrmMenuFiscal, uDmPosto, 

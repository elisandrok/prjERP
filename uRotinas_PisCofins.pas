...
uses
  ...
  ACBrSpedFiscal, ACBrEPCBlocos, ACBrUtil, ACBrTXTClass, DB, DBClient, 
...
uses
  ACBrEPCBloco_0, ACBrEPCBloco_C, ACBrEPCBloco_C_Class, ACBrEPCBloco_A_Class, 
  ACBrEPCBloco_A, ACBrEPCBloco_F, ACBrEPCBloco_F_Class, ACBrEPCBloco_1_Class, 
  ACBrEPCBloco_1, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, 
...
var AuxStr, aUF, aSitTribIPI : String;
    ...
    QNota,QItem : TFDQuery;
    Q400,Q405,Q481,Q485,Q490 : TFDQuery;
...
begin
   ...
   Q481 := TFDQuery.Create(nil);
   Q485 := TFDQuery.Create(nil);
   Q490 := TFDQuery.Create(nil);
   QNota.Connection := ConexaoDados;
   QItem.Connection := ConexaoDados;
   Q400.Connection := ConexaoDados;
   Q405.Connection := ConexaoDados;
   Q481.Connection := ConexaoDados;
   Q485.Connection := ConexaoDados;

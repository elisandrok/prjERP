...
procedure TFrmConfigPosto.FrameConfirmaCancela1BtnConfirmarClick(Sender: TObject);
begin
  inherited;
  Grava_Dados(DataConfig.DataSet);
...
procedure TFrmConfigPosto.FrameConfirmaCancela1BtnCancelarClick(Sender: TObject);
begin
  inherited;

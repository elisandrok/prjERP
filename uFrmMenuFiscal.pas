...
uses
  ...
  Mask, ACBrDevice, ACBrSpedFiscal, ACBrTEFD, ACBrSintegra, ACBrPAF, ACBrRFD, 
  ACBrBase, ACBrECF, IniFiles, ACBrEFDBlocos, ACBrUtil, ACBrTXTClass, Menus, 
  jpeg, ACBrPAFClass, DBClient;
...
uses
  uDmWorkCom, uLibrary, uFuncoesPAFECF, uFrmSelListaEstoque, MD5, uDmAcBr, 
  uMensagem, uDmSPED, uDmAuxiliar, uDmProdutos;

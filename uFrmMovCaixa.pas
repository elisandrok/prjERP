...
procedure TFrmMovCaixa.FrameConfirmaCancela1BtnConfirmarClick(Sender: TObject);
begin
  inherited;
  if (DataCaixaMov.DataSet.FieldByName('DC').IsNull) or (DataCaixaMov.DataSet.FieldByName('DC').AsString = '') then
  begin
...
procedure TFrmMovCaixa.FrameConfirmaCancela1BtnCancelarClick(Sender: TObject);
begin
  inherited;

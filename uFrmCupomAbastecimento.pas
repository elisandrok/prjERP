...
uses
  ...
  DBGrids, FMTBcd, DBClient, Provider, Menus, ComCtrls, uFuncoesPosto, ShellApi, 
  jpeg, IniFiles, System.Actions, FireDAC.Stan.Option;
...
uses
  uDmWorkCom, uLibrary, uFrmMenuFiscal, uFuncoesPAFECF, uDmPosto, uDmAuxiliar, 
  uFuncoesSoftPlus, untFuncoesPAF, uFrmProdPosto, uDmProdutos, 

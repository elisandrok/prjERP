...
procedure TFrmProdComposto.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmProdComposto.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
begin
  ...
  DataWork.DataSet.FieldByName('VALOR').AsCurrency := DataWork.DataSet.FieldByName('QUANTIDADE').AsCurrency * Dataproduto.DataSet.FieldByName('PRECO_COMPRA')
    .AsCurrency;
  inherited;

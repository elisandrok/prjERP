...

{
  ...
  Forms, Dialogs,ShellApi, FMTBcd, DBXpress, SqlExpr, DB, ExtCtrls, Menus,
  StdCtrls, Buttons, jpeg, DBClient, Provider, IniFiles, ActnList, ComCtrls;
  ...
  // DLL da companytec.
  Function InicializaSerial(np:byte): Boolean; stdcall; External 'companytec.dll';
  Function InicializaSocket(ip:string): Boolean; stdcall; External 'companytec.dll';
  Function FechaSocket: boolean; stdcall; External 'companytec.dll';
  Function FechaSerial: DWORD; stdcall; External 'companytec.dll';
  Function LeVisualizacao():OnLine; stdcall; External 'companytec.dll';
  Function LeAbastecimento():abast; stdcall; External 'companytec.dll';
  Function LeAbastecimentoFid():AbastFid; stdcall; External 'companytec.dll';   // retorna a identificacao funcionario.

  Function LeAbastecimentoFid2():AbastFid2; stdcall; External 'companytec.dll'; // retorna a identificacao do cliente e funcionario.
  Function AlteraPreco(bico:string;preco:double;decimais:byte):error; stdcall; External 'companytec.dll';

  Function LeSTEncerrante(Modo,Bico:String):stEncerrante; stdcall; External 'companytec.dll';

  Function deleteTagFid(posicao:integer;tag:string):integer; stdcall; External 'companytec.dll';
  Function saveTagFid(controle1,controle2:char;tag,t1in,t1out,t2in,t2out:string):integer; stdcall; External 'companytec.dll';
  procedure clearTagFid; stdcall; External 'companytec.dll';

  function LeStStatus:StStatus; stdcall; External 'companytec.dll';

  Function SocketOpen:boolean; stdcall; External 'companytec.dll';
  Function PortOpen:boolean; stdcall; External 'companytec.dll';
  Function Comunica:boolean; stdcall; External 'companytec.dll';

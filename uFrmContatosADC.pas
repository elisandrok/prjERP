...
uses
  ...
  ExtCtrls, Grids, DBGrids, ComCtrls, ActnList, DB, System.Actions;
...
procedure TFrmContatosADC.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmContatosADC.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;

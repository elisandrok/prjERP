      ...
      begin
        ...
        begin
          ...
          begin
            case aIndice of
              1:
                CdsEnderecoCEP.AsString := Trim(aux);
              2:
                CdsEnderecoENDERECO.AsString := Copy(aux, 2, Length(aux) - 2);
              3:
                CdsEnderecoBAIRRO.AsString := Copy(aux, 2, Length(aux) - 2);
              4:
                CdsEnderecoCIDADE.AsString := Copy(aux, 2, Length(aux) - 2);
              5:
...
procedure TFrmBuscaEnd.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  CdsEndereco.Close;
  CdsEndereco.Free;

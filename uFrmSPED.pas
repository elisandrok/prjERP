...
uses
  ...
  Dialogs, ComCtrls, ExtCtrls, ActnList, Buttons, StdCtrls, CheckLst, DB, 
  DBClient, DBCtrls, System.Actions;
...
uses
  uLibrary, uDmSPED, uFrmSenha, uDmAcBr, FireDAC.Stan.Intf, FireDAC.Stan.Option, 

...
uses
  ...
  ACBrSEF2_BlocoE, Buttons, ACBrSEF2, ACBrSEF2Conversao, ACBrBase;
...
uses
  ACBrSEF2_eDoc_BlocoC_Class, ACBrSEF2_Bloco0_1, ACBrSEF2_Bloco0,
  ACBrSEF2_BlocoE_1, uLibrary, uDmWorkCom, uDMClientes, DB, FireDAC.Stan.Intf,
...
begin
  ...
  cbbPRF_ICMS.Text := cINI.ReadString('eDOC', 'Indicador de exigibilidade da escrituração do ICMS:',
  ...
  cbbIND_ST.Text := cINI.ReadString('eDOC', 'Indicador de operações sujeitas à substituição tributária do ICMS, na condição de contribuinte-substituto:',
    '1- Não');
          ...
          begin
            ...
            case DmWorkCom.CdsEmpresa.FieldByName('NOME_RESP').AsInteger of
              0:
                COD_ASSIN := qaDiretor;
              1:
                COD_ASSIN := qaConsAdministracao;
              2:
                COD_ASSIN := qaAdministrador;
              3:
                COD_ASSIN := qaAdmGrupo;
              4:
                COD_ASSIN := qaAdmSociedadeFiliada;
              5:
                COD_ASSIN := qaAdmJudicialPessoaFisica;
              6:
                COD_ASSIN := qaAdmJudicialPessoaJuridica;
              7:
                COD_ASSIN := qaAdmJudicial;
              8:
                COD_ASSIN := qaGestorJudicial;
              9:
                COD_ASSIN := qaProcurador;
              10:
                COD_ASSIN := qaInventariante;
              11:
                COD_ASSIN := qaLiquidante;
              12:
                COD_ASSIN := qaInterventor;
              13:
                COD_ASSIN := qaEmpresario;
              14:
          ...
          begin
            ...
            case wIndiceOpcao of
              0:
                IND_ARQ := arqOriginal;
              1:
                IND_ARQ := arqTranscricaoEmissaoPropria;
              2:
                IND_ARQ := arqTranscricaoEmissaoTerceiros;
              3:
                IND_ARQ := arqTrancricaoDigitalizacao;
              4:
                IND_ARQ := arqTranscricaoEmissaoEquipEspecilizado;
              5:
                IND_ARQ := arqLivrosResultadosObrigacoes;
              6:
                IND_ARQ := arqLivroMapaControles;
              7:
                IND_ARQ := arqGuiasInfEconomicasFiscais;
              8:
                IND_ARQ := arqLivrosContabilidade;
              9:
            ...
            case wIndiceOpcao of
              0:
                PRF_ISS := impSimRegimeSimplificado;
              1:
                PRF_ICMS := impSimRegimeIntegral;
            end;
            ...
            case wIndiceOpcao of
              0:
                IND_EC := esCompletaArquivo;
              1:
                IND_EC := esCompletaPapel;
              2:
                IND_EC := esSimplificadaArquivo;
              3:
                IND_EC := esSimplificadaPapel;
              4:
                IND_EC := esLivroCaixaArquivo;
              5:
                IND_EC := esLivroCaixaPapel;
              6:
                IND_EC := esNaoObrigado;
            end;

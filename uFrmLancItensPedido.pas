...
Uses uLibrary, uDmWorkCom, uFrmProdutos, uDmProdutos;
...
procedure TFrmLancItensPedido.DbIDProdutoKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  TabEnter(Self, Key);
...
begin
  ...
  begin
    ...
    begin
      ...
      DataItens.DataSet.FieldByName('VALOR').AsFloat := DmProdutos.CdsProdutosPRECO_VENDA.AsFloat;
    end
    else
    begin

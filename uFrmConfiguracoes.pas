...
uses
  ...
  Spin, ACBrUtil, Printers, System.Actions, ACBrBase, ACBrPosPrinter, IniFiles,
  Vcl.FileCtrl;
...
procedure TFrmConfiguracoes.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmConfiguracoes.DataConfigDataChange(Sender: TObject; Field: TField);
begin
  inherited;
  HabilitaFrameConfig;
...
procedure TFrmConfiguracoes.DataWorkDataChange(Sender: TObject; Field: TField);
begin
  inherited;
...
begin
  if (DataWork.DataSet.FieldByName('UF').AsString = 'MS') or (DataWork.DataSet.FieldByName('UF').AsString = 'SC') then
  begin
    DataWork.DataSet.FieldByName('PERFIL_PAFECF').AsString := 'V';
  end;
  if (DataWork.DataSet.FieldByName('UF').AsString = 'AM') or (DataWork.DataSet.FieldByName('UF').AsString = 'DF') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'GO') or (DataWork.DataSet.FieldByName('UF').AsString = 'MA') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'PE') or (DataWork.DataSet.FieldByName('UF').AsString = 'RJ') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'RR') or (DataWork.DataSet.FieldByName('UF').AsString = 'TO') then
  begin
    DataWork.DataSet.FieldByName('PERFIL_PAFECF').AsString := 'W';
  end;
  if (DataWork.DataSet.FieldByName('UF').AsString = 'ES') or (DataWork.DataSet.FieldByName('UF').AsString = 'PB') then
  begin
  ...
  if (DataWork.DataSet.FieldByName('UF').AsString = 'AC') or (DataWork.DataSet.FieldByName('UF').AsString = 'AL') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'AP') or (DataWork.DataSet.FieldByName('UF').AsString = 'CE') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'MG') or (DataWork.DataSet.FieldByName('UF').AsString = 'PA') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'PR') or (DataWork.DataSet.FieldByName('UF').AsString = 'PI') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'RN') or (DataWork.DataSet.FieldByName('UF').AsString = 'RS') or
    (DataWork.DataSet.FieldByName('UF').AsString = 'RO') or (DataWork.DataSet.FieldByName('UF').AsString = 'SP') or
...
begin
  ...
  cbCidades.ItemIndex := cbCidades.Items.IndexOf(edtEmitCidade.Text + '/' + edtCodCidade.Text + '/' + edtEmitUF.Text);
...
begin
  inherited;
  DmAcBr.ACBrSAT1.AssociarAssinatura(DmWorkCom.CdsDadosTecnicosCNPJ.AsString + DmWorkCom.CdsEmpresaCNPJ_CPF.AsString,

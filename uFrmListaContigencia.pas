...
uses
  ...
  Dialogs, uFrmPadrao, FMTBcd, ExtCtrls, DB, DBClient, Provider, Grids, DBGrids, 
  ActnList, StdCtrls, Buttons, FireDAC.Stan.Intf, FireDAC.Stan.Option, 
...
uses
  uDmConexao, uDmWorkCom, uDmAcBr, uLibrary, ACBrNFeConfiguracoes;
...
begin
  ...
  begin
    ...
    RdTipoEmiss.ItemIndex := DmWorkCom.CdsPedidos.FieldByName('NFE_TIPOEMISS').AsInteger - 1;

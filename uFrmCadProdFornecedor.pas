...
procedure TFrmCadProdFornecedor.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmCadProdFornecedor.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;

...
procedure TFrmComprasConsulta.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TFrmComprasConsulta.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if (Key = #13) then
...
procedure TFrmComprasConsulta.DataiKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  TabEnter(Self, Key);

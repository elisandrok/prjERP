...
procedure TFrmCadPlanoConta.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TFrmCadPlanoConta.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmCadPlanoConta.DBEdit1KeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  TabEnter(Self, Key);

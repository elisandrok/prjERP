...
uses
  uFrmCadastroCliente, uDMClientes, uLibrary, uFrmSelEndereco, uFrmContatosADC;
...
begin
  inherited;
  frxReport1.LoadFromFile(ExtractFilePath(Application.ExeName) + 'Report\RelClientes.fr3');
...
begin
  ...
  if CbxTipoPesq.ItemIndex = 0 then // Codigo
    ...
    QryConsulta.SQL.Add('where contato.nome like :pOpcao')

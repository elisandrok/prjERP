...
procedure TFrmAgendaCompromissos.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmAgendaCompromissos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;

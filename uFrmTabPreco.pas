...
uses
  ...
  Dialogs, uFrmPadrao, Grids, DBGrids, DB, StdCtrls, ExtCtrls, DBCtrls, Buttons,
  FMTBcd, DBClient, Provider, ActnList, Menus, System.Actions;
...
type
  TFrmTabPreco = class(TFrmPadrao)
    ...
    procedure ReajustarPreosdevendadeprodutoscomposto1Click(Sender: TObject);
  private
...
uses
  uLiBrary, uDmWorkCom, uDmProdutos, uDMClientes;
...
procedure TFrmTabPreco.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TFrmTabPreco.ReajustarPreosdevendadeprodutoscomposto1Click(Sender: TObject);
begin
  inherited;

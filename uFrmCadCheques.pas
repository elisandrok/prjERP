...
procedure TFrmCadCheques.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
begin
  ...
  begin
    if (DataWork.DataSet.RecordCount > 0) and (not(DataWork.DataSet.State in [dsInsert, dsEdit])) then
    begin

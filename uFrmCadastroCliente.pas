...
type
  ...
  public
    ...
    sCadNFe: Boolean;
    //
    xNOME, xENDERECO, xNUM_END, xBAIRRO_END, xCIDADE_END, xCEP_END, xTELEFONE, xCNPJ_CPF, xINSC_RG, xCOMPLEMENTO, xUF_END, xCODCIDADE: String;
  end;
...
begin
  inherited;
  if (DataWork.DataSet.FieldByName('CEP_END').AsString <> '') or not(DataWork.DataSet.FieldByName('CEP_END').IsNull) then
  begin
...
begin
  inherited;
  if (DataWork.DataSet.FieldByName('CEP_END_ENTREGA').AsString <> '') or not(DataWork.DataSet.FieldByName('CEP_END_ENTREGA').IsNull) then
  begin
...
begin
  if (DataWork.DataSet.FieldByName('CNPJ_CPF').IsNull) or (DataWork.DataSet.FieldByName('CNPJ_CPF').AsString = '') then
  begin
  ...
  if (DataWork.DataSet.FieldByName('CODCIDADE').IsNull) or (DataWork.DataSet.FieldByName('CODCIDADE').AsString = '') then
  begin

...
procedure TFrmCadFormaPag.FrameBotaoVertical1BtnPesquisarClick(Sender: TObject);
begin
  inherited;
  PageControl1.TabIndex := 0;
...
procedure TFrmCadFormaPag.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmCadFormaPag.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;

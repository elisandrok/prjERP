...
procedure TFrmCadRegistro60.DataWorkDataChange(Sender: TObject; Field: TField);
begin
  inherited;
...
procedure TFrmCadRegistro60.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmCadRegistro60.Grid60AKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if (Key = #13) then

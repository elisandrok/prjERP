...
procedure TFrmCadClassPedido.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmCadClassPedido.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;

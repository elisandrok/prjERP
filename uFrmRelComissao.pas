...
uses
  ...
  Dialogs, uFrmPadrao, FMTBcd, DB, uFrameConfirmaCancela, ExtCtrls, StdCtrls,
  DBCtrls, ComCtrls, ActnList, Provider, DBClient, System.Actions;
...
uses
  uLibrary, uDmConexao, uDmWorkCom, uDMClientes, uDmRelatorios;

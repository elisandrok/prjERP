...
begin
  ...
  begin
    ...
    begin
      MessageDlg('SoftWare de Demonstração!' + #13 + #10 + 'Não é permitido ultrapassar o limite de contatos estabelecido,' + #13 + #10 + 'Máximo ' +
        IntToStr(pNumCli) + '. Entre em contato com o suporte técnico!!!', mtWarning, [mbOK], 0);
      Abort;
    end;
  end;

object DmProdutos: TDmProdutos
  ...
  Height = 512
  Width = 799
  object QryFechamentoEst: TFDQuery
  ...
  object QryMovimentoEst: TFDQuery
    Connection = DmConexao.Conexao
    SQL.Strings = (
  ...
  object QryProduto_Aliquota: TFDQuery
    Connection = DmConexao.Conexao
    SQL.Strings = (
  ...
  object QryProdutoComposto: TFDQuery
    Connection = DmConexao.Conexao
    SQL.Strings = (
  ...
  object QryCSTPisCofins: TFDQuery
    Connection = DmConexao.Conexao
    SQL.Strings = (

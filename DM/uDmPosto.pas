...
begin
  ...
  begin
    ...
    begin
      ...
      // 1 minuto = 60 segundos então 10 minutos = 600
...
begin
  ...
  try
    ...
    MessageDlg('Erro ao executar comando de conexão com o concentrador!', mtWarning, [mbOK], 0);
  end;
...
begin
  ...
  try
    ...
    MessageDlg('Erro ao executar comando de desconexão com o concentrador!', mtWarning, [mbOK], 0);
  end;

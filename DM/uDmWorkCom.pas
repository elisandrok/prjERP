  ...
  try
    ...
    try
      ...
      begin
        ...
        MessageDlg('Não há abastecimentos pendentes!!', mtWarning, [mbOK], 0);
      Q.Close;
    finally
      FreeAndNil(Q);
    end;
...
begin
  ...
  try
    ...
    begin
          ...
          begin
            ...
            begin
              ...
              { if not NFCe then
                ...
                (Copy(DmWorkCom.CdsPedidoItensCST.AsString,2,2) = '41') then // 2 - Não tributado
                begin
                with II do
                begin
      ...
      if not NFCe then
      begin
        Transp.modFrete := mfContaEmitente; // NFC-e não pode ter FRETE
...
begin
  ...
  begin
    ...
    PAFECF.ImprimeRelatorioGerencial('Emissão: ' + FormatDateTime('DD/MM/YYYY', CdsPedidosDATA_ENTREGA.AsDateTime) + ' ' + FormatDateTime('HH:MM:SS',
      CdsPedidosHORA_ENTREGA.AsDateTime));
    PAFECF.ImprimeRelatorioGerencial('------------------------------------------------');
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                aMensagem := aMensagem + 'ECF: ' + DmWorkCom.PAFECF.gCaixa + ' - Conferência de Mesa - ' + 'CER nº ' +
                  ZeroEsquerda(CdsPedidos.FieldByName('CER').AsString, 4) + ' - COO nº ' + ZeroEsquerda(CdsPedidos.FieldByName('COO_CONF_MESA').AsString, 6) +
                  #13 + #10;
              end
              else
              begin
...
begin
  ...
  begin
    ...
    try
      ...
      prn.SendData('------------------------------------------------' + #13 + #10);
      prn.SendData('E vedado a autenticação deste documento.' + #13 + #10);
      prn.SendData('SEM VALOR FISCAL' + #13 + #10);
      prn.SendData('------------------------------------------------' + #13 + #10);
      prn.SendData('Numero do pedido: ' + CdsPedidosPEDIDO_NUM.AsString + #13 + #10);
      prn.SendData('Emissão: ' + FormatDateTime('DD/MM/YYYY', CdsPedidosDATA_ENTREGA.AsDateTime) + ' ' + FormatDateTime('HH:MM:SS',

...
procedure TFrmCadTanques.ActionList1Update(Action: TBasicAction; var Handled: Boolean);
begin
  inherited;
...
procedure TFrmCadTanques.DataWorkDataChange(Sender: TObject; Field: TField);
begin
  inherited;

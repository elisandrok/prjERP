...
uses
  ...
  ExtCtrls, Buttons, DB, DBClient, FMTBcd, System.Actions;
...
uses
  uLibrary, uDmWorkCom, uDmAuxiliar;
...
begin
  ...
  try
    ...
    if Ch10.Checked then
      DmWorkCom.ProcessaRegistro10(Datai.Date, Dataf.Date, copy(ComboEstrutura.Text, 1, 1), copy(ComboNatureza.Text, 1, 1), copy(ComboFinalidade.Text, 1, 1));

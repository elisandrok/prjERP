...
begin
  ...
  Application.Title := 'Controle Comercial';
    ...
    begin
      ...
      begin
        MessageDlg('Sisema Expirou. Entre em contato com o Suporte Técnico!!!', mtWarning, [mbOK], 0);
        Application.Terminate;
      end;
      // exibe dias para expirar
      MessageDlg('Versão de Demonstração.' + #13 + #10 + 'Expira Em ' + FloatToStr(pDiasExpira) + ' Dias.', mtWarning, [mbOK], 0);
    end;
